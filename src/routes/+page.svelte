...
<!-- Hero Section -->
<section
  class="bg-gray-100 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12"
>
  <h1
  ...
  >
    Ready to revolutionize your blogging experience? Join Us Today!
  </p>
  <div
  ...
  >
    <a
      href="/auth/Register"
      class="inline-flex justify-center items-center py-3 px-5 text-base font-bold text-center text-white bg-blue-500 rounded-lg border border-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 shadow-md transition-transform transform hover:scale-105"
    >
      Sign Up
    </a>
    <a
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
    ...
    >
      ...
      <p class="text-gray-500">
        Secure and transparent transactions are facilitated through blockchain
        wallet connections.
      </p>
    </div>
    <div
    ...
    >
      ...
      <p class="text-gray-500">
        Authors can set a price for their blogs, allowing them to earn directly
        from their content.
      </p>
    </div>
    <div
...
<section
  class="bg-blue-500 py-8 px-4 mx-auto max-w-screen-xl text-center text-white"
>
  <h2 class="text-3xl font-bold mb-6">Ready to Get Started?</h2>
  <p class="mb-8 text-lg">
    Join the BlogVerse community today and start sharing your stories with the
    world!
  </p>
  <a
    href="/auth/Register"
    class="inline-flex justify-center items-center py-3 px-5 text-base font-bold text-center bg-white text-blue-500 rounded-lg border border-blue-500 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 shadow-md transition-transform transform hover:scale-105"
  >
    Sign Up Now
  </a>
</section>
