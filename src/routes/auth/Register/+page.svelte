...
<div class="flex flex-col items-center justify-center min-h-screen bg-gray-100">
  {#if message}
    <div class={`w-full p-4 mb-4 ${messageType === 'success' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
      <p class="text-center">{message}</p>
    </div>
  {/if}
  <div class="bg-yellow-300 p-6 rounded-lg shadow-lg w-full max-w-md hover:shadow-xl">
